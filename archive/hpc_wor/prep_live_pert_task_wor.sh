#!/bin/bash -l
# prep_live_pert_task_wor.sh
# Single-node SLURM job: concatenate WoR live-perturbation frame files.
...
#SBATCH -J atoms_wor_prep_live_pert
#SBATCH -o /ptmp/%u/atoms_wor_live_pert/logs/prep_%j.out
#SBATCH -e /ptmp/%u/atoms_wor_live_pert/logs/prep_%j.err
#SBATCH --ntasks=1
...
srun python3 "$CODE_DIR/hpc/prep_live_pert_wor.py" \
