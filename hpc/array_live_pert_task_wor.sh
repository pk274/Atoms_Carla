#!/bin/bash -l
# array_live_pert_task_wor.sh
# Per-task script for the WoR live-perturbation ATOMs SLURM array job.
...
#   CONCAT_FILE   path to live_pert_concat.npz (from prep_live_pert.py)
...
#SBATCH -J atoms_wor_live_pert
#SBATCH -o /ptmp/%u/atoms_wor_live_pert/logs/chunk_%A_%a.out
#SBATCH -e /ptmp/%u/atoms_wor_live_pert/logs/chunk_%A_%a.err
#SBATCH --ntasks=1
