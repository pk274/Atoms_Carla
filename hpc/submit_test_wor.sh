...
echo "  ATT=/u/\$USER/pcla/data/WOR/test_data/attention"
echo "  cp $PROFILES_OUT                                   \$ATT/test_profiles_${MODE_ANALYSIS}.npy"
echo "  cp $WORK_DIR/test_logits_${MODE_ANALYSIS}.npy      \$ATT/test_logits_${MODE_ANALYSIS}.npy"
echo "  cd /u/\$USER/pcla"
echo "  git add -f data/WOR/test_data/attention/test_profiles_${MODE_ANALYSIS}.npy"
echo "  git add -f data/WOR/test_data/attention/test_logits_${MODE_ANALYSIS}.npy"
echo "  git commit -m 'add WOR test_profiles_${MODE_ANALYSIS}.npy and test_logits_${MODE_ANALYSIS}.npy from HPC'"
echo "  git push"
