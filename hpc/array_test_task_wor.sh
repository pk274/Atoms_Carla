#!/bin/bash -l
# array_test_task_wor.sh
# Per-task script for the WoR test-set ATOMs SLURM array job.
...
#   LABELED_FILE  path to test_labeled.npz (from prep_test_wor.py)
...
#SBATCH -J atoms_wor_test
#SBATCH -o /ptmp/%u/atoms_wor_test/logs/chunk_%A_%a.out
#SBATCH -e /ptmp/%u/atoms_wor_test/logs/chunk_%A_%a.err
#SBATCH --ntasks=1
