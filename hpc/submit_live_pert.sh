...
echo "  cp $WORK_DIR/live_pert_speed_logits.npy       \$ATT/live_pert_speed_logits.npy"
echo "  cd /u/\$USER/pcla"
echo "  git add -f data/TFV6/test_data/attention/live_pert/\$PERT/live_pert_profiles.npy"
echo "  git add -f data/TFV6/test_data/attention/live_pert/\$PERT/live_pert_speed_logits.npy"
echo "  git commit -m 'add live_pert_profiles for \$PERT from HPC'"
echo "  git push"
