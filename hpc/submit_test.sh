...
echo "  cp $WORK_DIR/test_speed_logits.npy    /u/\$USER/pcla/data/TFV6/test_data/attention/test_speed_logits.npy"
echo "  cd /u/\$USER/pcla"
echo "  git add -f data/TFV6/test_data/attention/test_profiles.npy"
echo "  git add -f data/TFV6/test_data/attention/test_speed_logits.npy"
echo "  git commit -m 'add TFV6 test_profiles.npy and test_speed_logits.npy from HPC'"
echo "  git push"
